    ...
    Private Sub btn_proses_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button_proses.Click
        Try
            Select Case Combo_pola.Text
                Case "Pyramid"
                    pyramid(Convert.ToInt32(Tbox_baris.Text))
                Case "Hollow Pyramid"
                    hollowPyramid(Convert.ToInt32(Tbox_baris.Text))
                Case "Inverted Pyramid"
                    invertedPyramid(Convert.ToInt32(Tbox_baris.Text))
                Case "Hollow Inverted Pyramid"
                    hollowInvertedPyramid(Convert.ToInt32(Tbox_baris.Text))
                Case Else
                    Tbox_hasil.Text = "Anda Belum Memilih Pola"
            End Select
        Catch ex As Exception
            Tbox_hasil.Text = "Masukan Bukan Angka"
        End Try
    End Sub
